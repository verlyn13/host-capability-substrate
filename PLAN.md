...
Direct-test queue (combined from report 1 §14 + report 2 verification + shell research v2.3.0 P01–P13; blocks work that depends on each outcome):
...
### Phase 1 shell/environment research program (shell research v2.3.0, 2026-04-27 → 2026-05-08)
